...
class MovieFileCSVReaderActor:

    def __init__(self, file_name, actor_name):
    ...
    def read_csv_file(self):
        with open(self.__file_name, mode='r', encoding='utf-8-sig') as csvfile:
            movie_file_reader_actor = csv.DictReader(csvfile)

            for row in movie_file_reader_actor:
                movie = row['Title']
                ...
                if self.__actor_name in actors:
